                                ...
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                                    <div class="login-top sign-top">
                                        <form action="php/signup.php" method="post">
                                            ...
                                            <label>College : </label>
                                            <input id="college" name="college" type="text" class="college" placeholder="IIT-B/NIT-Surat/AIIMES" required="" />
                                            <label>Degree : </label>
                                            <input id="degree" name="degree" type="text" class="degree" placeholder="B-Tech/M.Sc." required="" />
                                            <label>Specialization : </label>
                                            <input id="spec" name="spec" type="text" class="spec" placeholder="Computer Engg./Physics" required="" />
                                            <label>Passing Year :</label>
                                            <input id="passyear" name="passyear" type="number" class="passyear" placeholder="2010" min="1960" max="2050" required="" />
                                            <!-- <input id="qualification" name="qualification" type="text" class="qualification" placeholder="B-tech/B.com/M.phil" required=""/>  -->
                                            <label>Languages:</label>
                                            <select name="lang[]" id="lang" class="selectpicker" multiple>
