...
$id=$_GET["id"];
$find="SELECT * FROM `branch_review` WHERE `id`='$id'";
        ...
        <div class="container clearfix">
          <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-12"> 
              <h1 class="he"><?php echo $row['clg']; ?>
			  <br>
			  <?php echo $row['branch']; ?></span></h1>
            </div>
          </div>
        </div>
      </div>
...
<div class="container conta" style=" margin-top:20px;"> 
                              <div class="col-md-9 " >
                                <div class="bar">
                                 <p><a href="/"class="upper"><strong >Home</strong></a> || <a href="index.php"class="upper"><strong>Branch Review</strong></a>
...
<div id="branch" class="branch">
  ...
  <div class="branch entertain_box" id="project">
      ...
      <div class="branch-info" style=" margin-bottom:40px;  ">
		<h3 class="heading">Branch:<?php echo $row['branch']; ?></h3>
...
<div class="fb-comments" data-href="http://careercrucible.com/branchreview/see_branch_review.php?id=<?php echo $id; ?>" data-width="752" data-numposts="7"></div>
</div>
</div>
<?php
