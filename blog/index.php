...
<html>
	<head>
		...
		<title>Blogs | Career Crucible</title>
					...
					<div class="branch entertain_box" id="project">
						...
						<div class="row ">
							...
							<div class="col-md-8  mar">
								<div class="team-member">
									<h3 class="head"><a href='php/article.php?id=<?php echo $row["blog_id"]; ?>'> <?php echo $row["title"]; ?> </a></h3>
									<p> <?php echo $string ?>
										</p><a href='php/article.php?id=<?php echo $row["blog_id"]; ?>' class="read" style="text-decoration:none;">READ MORE</a>
									</div>
								</div>
