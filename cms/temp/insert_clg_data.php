...
<div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
              ...
              <form action="../php/insert_clg_data_db.php" method="post"  enctype="multipart/form-data" novalidate>
              ...
              <div class="single-about-detail">
                <div class="about-details">
                  ...
                  <p><strong>Extra Information:</strong>
					<input type="text" name="clg_area_extra" class="form-control">
                </div>
              </div>
			<br>
...
ndiv.innerHTML="<input type='text' name='course[]' placeholder='course name' class='form-control' ><br>";
...
var ndiv=document.createElement('div');
ndiv.innerHTML="<input type='text' name='arch[]' placeholder='course name' class='form-control' ><br>";
...
var ndiv=document.createElement('div');
ndiv.innerHTML="<input type='text' name='mtech[]' placeholder='course name' class='form-control' ><br>";
...
var ndiv=document.createElement('div');
ndiv.innerHTML="<input type='text' name='msc[]' placeholder='course name' class='form-control' ><br>";
...
count_msc++;
   ...
   <div class="container conta"  >
        ...
        <section id="text" class="col-md-9 section-gray" >
            ...
            <h3><strong>Courses Offered &amp Reviews</strong></h3>
	  ...
	  <div id="add_field">
       </strong><input type="text" name="course[]"  placeholder="course name" class="form-control" required ><br>
      </div>
	  <input type="button" value="Add Another course" onClick="add_fields()" class="form-control">
	  </div>
      </div>
               
              <div class="courses">
               <a href="#mtech"  style="text-decoration:none;" ><h4>Add B.Arch Courses</h4></a>
         <div class="slidingDiv" id="barch">
           <div id="add_field1">
       </strong><input type="text" name="arch[]"  placeholder="course name" class="form-control"  ><br>
      </div>
	  <input type="button" value="Add Another course" onClick="add_fields1()" class="form-control">
	  </div>
        </div>
       ...
       <div id="add_field2">
       </strong><input type="text" name="mtech[]"  placeholder="course name" class="form-control"  ><br>
      </div>
	  <input type="button" value="Add Another course" onClick="add_fields2()" class="form-control">
	  </div>
      </div>
        ...
        <div id="add_field3">
       </strong><input type="text" name="msc[]"  placeholder="course name" class="form-control"  ><br>
      </div>
	  <input type="button" value="Add Another course" onClick="add_fields3()" class="form-control">
...
var ndiv=document.createElement('div');
ndiv.innerHTML="<input type='text' name='placement_branch[]'  class='form-control'>";
document.getElementById("f1_placement").appendChild(ndiv);
var n1div=document.createElement('div');
n1div.innerHTML="<input type='text' name='placement_max_sal[]'  class='form-control'>";
document.getElementById("f2_placement").appendChild(n1div);
var n2div=document.createElement('div');
n2div.innerHTML="<input type='text' name='placement_avg_sal[]'  class='form-control'>";
...
var ndiv=document.createElement('div');
ndiv.innerHTML="<input type='text' name='past_recruties[]'  class='form-control'>";
document.getElementById("f5_placement").appendChild(ndiv);
}
function add_fields6(){
var ndiv=document.createElement('div');
ndiv.innerHTML="<input type='text' name='top_recruties[]'  class='form-control'>";
            ...
            <div class="row">
              ...
              <div>
                <h4>Past Recruiters</h4>
                  <div class="popular-post-grids">
                       <div id="f5_placement">
                      <input type="text" name="past_recruties[]" required class="form-control">
                    </div>
					<br><input type="button" value="Add Another" onClick="add_fields5()" class="form-control">
              ...
              <div><hr>
				 ...
				 <h4>Top RECRUITERS</h4>
                   <div id="f6_placement">
                      <input type="text" name="top_recruties[]" required class="form-control">
                    </div>
					<br><input type="button" value="Add Another" onClick="add_fields6()" class="form-control">
